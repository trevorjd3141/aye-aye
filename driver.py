...
def main():
    ...
    if OPTIONS['extraction']:
        if MULTI_CATEGORICAL_LEARNING:
            aye_aye.aye_aye(SETTINGS, INTERMEDIATE_DATA_PATH, TRUNCATED_DATA, EXTRACTIONS_PATH, DOCS_PATH, MUTUAL_EXCLUSION, SEMANTIC_DRIFT_FILTERING, True)
        else:
            for setting in SETTINGS:
                aye_aye.aye_aye([setting], INTERMEDIATE_DATA_PATH, TRUNCATED_DATA, EXTRACTIONS_PATH, DOCS_PATH, MUTUAL_EXCLUSION, SEMANTIC_DRIFT_FILTERING, True)
