...
SETTINGS = [
    {'NAME': 'noun.person', 'LEFT_TOKENS': 0, 'PARENT_TOKENS': 2,
    'RIGHT_TOKENS': 0, 'LEFT_SIBLING': True, 'RIGHT_SIBLING': True,
    'MIN_PATTERN_COMPLEXITY': 2, 'MAX_PATTERN_COMPLEXITY': 2},
    {'NAME': 'noun.food', 'LEFT_TOKENS': 0, 'PARENT_TOKENS': 2,
    'RIGHT_TOKENS': 0, 'LEFT_SIBLING': True, 'RIGHT_SIBLING': True,
    'MIN_PATTERN_COMPLEXITY': 2, 'MAX_PATTERN_COMPLEXITY': 2},
]
